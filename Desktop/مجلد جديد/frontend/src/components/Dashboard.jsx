...
import {
  ...
  FiUser, FiMail,
  FiUploadCloud, FiCheckCircle, FiClock, FiEdit
} from 'react-icons/fi';
          ...
          <div className={styles.settingsContainer}>
            ...
            <form onSubmit={handleSaveProfile} className={styles.settingsForm}>
              ...
              <div className={styles.settingsSection}>
                ...
                <div className={styles.formGrid}>
                  <div className={styles.inputGroup}>
                    ...
                    />
                    <p className={styles.helpText}>Contact support to change your name</p>
                  </div>
                  <div className={styles.inputGroup}>
                    ...
                    <input 
                      ...
                      className={styles.readOnlyInput}
                    />
                    <p className={styles.helpText}>Contact support to change your email</p>
                  </div>
                </div>
              </div>
              ...
              <div className={styles.formActions}>
                ...
                <button type="submit" className={styles.primaryButton} disabled={isSaving || !avatarFile}>
